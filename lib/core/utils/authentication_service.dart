...
class AuthenticationService {
  ...
  AuthenticationService({
    this.clientId = '6c3b8498989040639edc590aa11fb8b7',
    this.redirectUri = 'http://localhost:12925/callback',
  ...
  Future<List<dynamic>> searchPlaylists(String query, String accessToken) async {
    final url = Uri.https('api.spotify.com', '/v1/search', {
      'q': query,
      'type': 'playlist', // You can also add 'track', 'album', etc.
    ...
    if (response.statusCode == 200) {
      ...
      return data['playlists']['items']; // Adjust to get the playlists
    } else {
