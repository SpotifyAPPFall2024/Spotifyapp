...
class PlaylistSearchDelegate extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    return FutureBuilder<List<dynamic>>(
      future: AuthenticationService().searchPlaylists(query, accessToken),
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          return const Center(
            child: CircularProgressIndicator(),
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                title: Text(title),
                onTap: () {
                  // Perform some action when the user taps the playlist
                  close(context, playlist);
                },
              );
            },
          );
  ...
  Widget buildSuggestions(BuildContext context) {
    return Container(); // Can be left empty or show recent searches
  }
}
